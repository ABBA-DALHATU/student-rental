...
export default function SavedPropertiesPage({
  ...
  useEffect(() => {
    const fetchProperties = async () => {
      try {
        setIsLoading(true);
        const data = await getSavedProperties(userId);
        setProperties(data);
      ...
      <div className="space-y-6 w-full max-w-full">
        <div>
          ...
          <p className="text-muted-foreground">
            Your collection of favorite student accommodations.
          </p>
        </div>
            ...
            <Sheet open={isFilterOpen} onOpenChange={setIsFilterOpen}>
              ...
              <SheetContent className="sm:max-w-md">
                <SheetHeader>
                  ...
                  <SheetDescription>
                    Refine your saved properties with these filters
                  </SheetDescription>
                </SheetHeader>
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              {properties.length === 0
                ...
                : "No saved properties match your current filters."}
            </p>
            {properties.length === 0 ? (
...
// Property Card Component (same as in Browse Properties)
